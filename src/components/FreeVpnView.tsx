  ...
  return (
    <div className="space-y-8 animate-fade-in font-sans">
      ...
      {(() => {
        ...
        if (!isUnlocked) {
          return (
            <div className="bg-slate-900 border border-indigo-500/30 rounded-2xl p-6 md:p-8 space-y-6 max-w-2xl mx-auto shadow-2xl shadow-indigo-950/20 relative overflow-hidden animate-fade-in text-slate-200">
              ...
              <div className="text-center space-y-3 pb-6 border-b border-slate-850">
                ...
                <h3 className="text-lg font-bold text-white tracking-tight font-display">🔒 Get Free VPN Tunnel Catalog is Locked</h3>
                <p className="text-xs text-slate-400 max-w-md mx-auto leading-relaxed">
                  To authorize secure bypass protocols and access the free-tier servers list, you must complete the platform's verification gateway steps. Click the verification redirector 10 times.
                </p>
              </div>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-bold text-xs uppercase flex items-center gap-1.5 transition cursor-pointer ${
                      adRedirectionCount >= 10
                        ...
                        : 'bg-indigo-500 hover:bg-indigo-600 text-white shadow-lg shadow-indigo-950/40 scale-102 hover:scale-105'
                    }`}
                  >
                    {isLoadingActiveAd ? (
                      <>
        ...
        // Return regular selection catalog when unlocked
        return (
                    ...
                    {adRedirectionCount < 10 ? (
                      <div className="bg-slate-950/80 border border-indigo-500/20 p-5 rounded-2xl space-y-4 font-mono text-[11px]">
                        ...
                        <p className="text-slate-400 font-sans leading-relaxed">
                          To extract individual code bypass databases parameters, complete the confirmation steps below. Click the active network gateway 10 times to unlock this package.
                        </p>
                      ...
                      <>
                        <div className="bg-slate-950/80 border border-slate-850 p-5 rounded-2xl space-y-4 font-mono text-[11px]">
                          ...
                          <p className="text-slate-400 font-sans leading-relaxed">
                            To fetch and deploy voucher codes, confirm the activation block below. Overriding limits triggers secure database mapping on server nodes.
                          </p>
                        </div>
                          ...
                          <button
                            ...
                            className={`px-6 py-2.5 text-xs font-bold rounded-xl transition uppercase flex items-center gap-2 shrink-0 cursor-pointer shadow-lg ${
                              isClaimingFree
                                ...
                                : 'bg-emerald-505 hover:bg-emerald-600 text-slate-950 shadow-emerald-950/30 font-extrabold bg-emerald-500'
                            }`}
                          >
                            {isClaimingFree ? (
                              <>
